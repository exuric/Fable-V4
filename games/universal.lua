		...
		Function = function(callback)
			...
			if callback then
				...
				AimAssist:Clean(runService.RenderStepped:Connect(function(dt)
					...
					if rightClicked and not fable.gui.ScaledGui.ClickGui.Visible then
				...
				repeat
					if Mode.Value == 'Tool' then
						...
						if mouse1click and (isrbxactive or iswindowactive)() then
							if not fable.gui.ScaledGui.ClickGui.Visible then
...
run(function()
	...
	HighJump = fable.Categories.Blatant:CreateModule({
		Name = 'HighJump',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Invisible = fable.Categories.Blatant:CreateModule({
		Name = 'Invisible',
		Function = function(callback)
			if callback then
				animationTrickery()
...
run(function()
	...
	Jesus = fable.Categories.Blatant:CreateModule({
		Name = 'Jesus',
		Function = function(callback)
			if callback then
				local terrain = workspace:FindFirstChildWhichIsA('Terrain')
...
run(function()
	...
	MouseTP = fable.Categories.Blatant:CreateModule({
		Name = 'MouseTP',
		Function = function(callback)
			if callback then
				local position
...
run(function()
	...
	Phase = fable.Categories.Blatant:CreateModule({
		Name = 'Phase',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Spider = fable.Categories.Blatant:CreateModule({
		Name = 'Spider',
		Function = function(callback)
			if callback then
				if Truss then
...
run(function()
	...
	SpinBot = fable.Categories.Blatant:CreateModule({
		Name = 'SpinBot',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Swim = fable.Categories.Blatant:CreateModule({
		Name = 'Swim',
		Function = function(callback)
			if callback then
...
run(function()
	...
	TargetStrafe = fable.Categories.Blatant:CreateModule({
		Name = 'TargetStrafe',
		Function = function(callback)
			if callback then
				if not module then
				...
				local flymod, ang, oldent = fable.Modules.Fly or {Enabled = false}
...
run(function()
	...
	Timer = fable.Categories.Blatant:CreateModule({
		Name = 'Timer',
		Function = function(callback)
			if callback then
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('FableV4/assets/new/arrowmodule.png')
	...
	Arrows = fable.Categories.Render:CreateModule({
		Name = 'Arrows',
		Function = function(callback)
			if callback then
				...
				Arrows:Clean(fable.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
	...
	Chams = fable.Categories.Render:CreateModule({
		Name = 'Chams',
		Function = function(callback)
			if callback then
				...
				Chams:Clean(fable.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
	...
	ESP = fable.Categories.Render:CreateModule({
		Name = 'ESP',
		Function = function(callback)
			if callback then
				...
				if ColorFunc[methodused] then
					ESP:Clean(fable.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
	...
	Fullbright = fable.Categories.Render:CreateModule({
		Name = 'Fullbright',
		Function = function(callback)
			if callback then
...
run(function()
	...
	GamingChair = fable.Categories.Render:CreateModule({
		Name = 'GamingChair',
		Function = function(callback)
			if callback then
				if fable.ThreadFix then
				...
				--movingsound.SoundId = downloadFableAsset('fable/assets/ChairRolling.mp3')
				movingsound.Volume = 0.4
				movingsound.Looped = true
				movingsound.Parent = workspace
				flyingsound = Instance.new('Sound')
				--flyingsound.SoundId = downloadFableAsset('fable/assets/ChairFlying.mp3')
				...
				repeat
					if entitylib.isAlive and entitylib.character.Humanoid.Health > 0 then
						...
						local flying = fable.Modules.Fly and fable.Modules.Fly.Enabled or fable.Modules.LongJump and fable.Modules.LongJump.Enabled or fable.Modules.InfiniteFly and fable.Modules.InfiniteFly.Enabled
...
run(function()
	...
	PlayerModel = fable.Categories.Render:CreateModule({
		Name = 'PlayerModel',
		Function = function(callback)
			if callback then 
...
run(function()
	...
	Radar = fable:CreateOverlay({
		Name = 'Radar',
		Icon = getfableasset('FableV4/assets/new/radar.png'),
		...
		Function = function(callback)
			if callback then
				...
				Radar:Clean(fable.Categories.Friends.ColorUpdate.Event:Connect(function()
...
run(function()
	...
	Search = fable.Categories.Render:CreateModule({
		Name = 'Search',
		Function = function(callback)
			if callback then
...
run(function()
	...
	SessionInfo = fable:CreateOverlay({
		Name = 'Session Info',
			...
			if callback then
				...
				SessionInfo:Clean(playersService.LocalPlayer.OnTeleport:Connect(function()
					if not teleportedServers then
						...
						queue_on_teleport("shared.fablesessioninfo = '"..httpService:JSONEncode(fable.Libraries.sessioninfo.Objects).."'")
					end
				end))
	
				if shared.fablesessioninfo then
					for i, v in httpService:JSONDecode(shared.fablesessioninfo) do
						if fable.Libraries.sessioninfo.Objects[i] and v.Saved then
							fable.Libraries.sessioninfo.Objects[i].Value = v.Value
						end
					end
				end
	
				repeat
					if fable.Libraries.sessioninfo then
						local stuff = {''}
						if Title.Enabled then
							stuff[1] = TitleOffset.Enabled and '<b>Session Info</b>\n<font size="4"> </font>' or '<b>Session Info</b>'
						end
	
						for i, v in fable.Libraries.sessioninfo.Objects do
	...
	fable:Clean(SessionInfo.Children:GetPropertyChangedSignal('AbsolutePosition'):Connect(function()
		if fable.ThreadFix then
			setthreadidentity(8)
		end
		local newside = SessionInfo.Children.AbsolutePosition.X > (fable.gui.AbsoluteSize.X / 2)
	...
	fable.Libraries.sessioninfo:AddItem('Time Played', os.clock(), function(value)
...
run(function()
	...
	local function Loop()
		local screenSize = fable.gui.AbsoluteSize
	...
	Tracers = fable.Categories.Render:CreateModule({
		Name = 'Tracers',
		Function = function(callback)
			if callback then
				...
				Tracers:Clean(fable.Categories.Friends.ColorUpdate.Event:Connect(function()
					ColorFunc(Color.Hue, Color.Sat, Color.Value)
				end))
...
run(function()
	...
	WaypointFolder.Parent = fable.holder
	
	Waypoints = fable.Categories.Render:CreateModule({
		Name = 'Waypoints',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AnimationPlayer = fable.Categories.Utility:CreateModule({
...
run(function()
	...
	AntiRagdoll = fable.Categories.Utility:CreateModule({
		Name = 'AntiRagdoll',
		Function = function(callback)
			if entitylib.isAlive then
...
run(function()
	...
	AutoRejoin = fable.Categories.Utility:CreateModule({
		Name = 'AutoRejoin',
		Function = function(callback)
			if callback then
				local rejoinCheck
...
run(function()
	...
	Blink = fable.Categories.Utility:CreateModule({
		Name = 'Blink',
		Function = function(callback)
			if callback then
				local teleported
...
run(function()
	...
	ChatSpammer = fable.Categories.Utility:CreateModule({
		Name = 'ChatSpammer',
		Function = function(callback)
			if callback then
				if textChatService.ChatVersion == Enum.ChatVersion.TextChatService then
...
run(function()
	...
	Disabler = fable.Categories.Utility:CreateModule({
		Name = 'Disabler',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Rejoin = fable.Categories.Utility:CreateModule({
		Name = 'Rejoin',
		Function = function(callback)
			if callback then
...
run(function()
	...
	StateSpoofer = fable.Categories.Utility:CreateModule({
		Name = 'StateSpoofer',
		Function = function(callback)
			if callback then
...
run(function()
	...
	FastProxPrompt = fable.Categories.World:CreateModule({
		Name = 'FastProxPrompt',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Freecam = fable.Categories.World:CreateModule({
		Name = 'Freecam',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	Gravity = fable.Categories.World:CreateModule({
		Name = 'Gravity',
		Function = function(callback)
			if callback then
...
run(function()
	...
	MurderMystery = fable.Categories.World:CreateModule({
		Name = 'MurderMystery',
		Function = function(callback)
			if callback then
				...
				entitylib.getEntityColor = function(ent)
					ent = ent.Player
					if not (ent and fable.Settings.Modules.Options['Use team color'].Enabled) then return end
...
run(function()
	...
	Parkour = fable.Categories.World:CreateModule({
		Name = 'Parkour',
		Function = function(callback)
			if callback then
				local oldfloor
...
run(function()
	...
	Wallhop = fable.Categories.World:CreateModule({
		Name = 'Wallhop',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Xray = fable.Categories.World:CreateModule({
		Name = 'Xray',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Atmosphere = fable.Legit:CreateModule({
		Name = 'Atmosphere',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Breadcrumbs = fable.Legit:CreateModule({
		Name = 'Breadcrumbs',
		Function = function(callback)
			if callback then
...
run(function()
	...
	ChinaHat = fable.Legit:CreateModule({
		Name = 'China Hat',
		Function = function(callback)
			if callback then
				if fable.ThreadFix then
...
run(function()
	...
	Clock = fable.Legit:CreateModule({
		Name = 'Clock',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	Disguise = fable.Legit:CreateModule({
		Name = 'Disguise',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Keystrokes = fable.Legit:CreateModule({
		Name = 'Keystrokes',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Memory = fable.Legit:CreateModule({
		Name = 'Memory',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	Speedmeter = fable.Legit:CreateModule({
		Name = 'Speedmeter',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	TimeChanger = fable.Legit:CreateModule({
		Name = 'Time Changer',
		Function = function(callback)
			if callback then
