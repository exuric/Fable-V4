...
run(function()
	...
	AutoAction = fable.Categories.Combat:CreateModule({
		Name = 'AutoAction',
...
run(function()
	...
	MissCooldown = fable.Categories.Combat:CreateModule({
		Name = 'MissCooldown',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AntiHazard = fable.Categories.Blatant:CreateModule({
		Name = 'AntiHazard',
		Function = function(callback)
			if callback then
...
run(function()
	...
	FlyingAttack = fable.Categories.Blatant:CreateModule({
		Name = 'FlyingAttack',
		Function = function(callback)
			if callback then
...
run(function()
	...
	PickupTP = fable.Categories.Blatant:CreateModule({
		Name = 'PickupTP',
		Function = function(callback)
			if callback then
				local old
...
run(function()
	...
	SpeedSpin = fable.Categories.Blatant:CreateModule({
		Name = 'SpeedSpin',
		Function = function(callback)
			if callback then
...
run(function()
	...
	PickupTracers = fable.Categories.Render:CreateModule({
		Name = 'PickupTracers',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoCamel = fable.Categories.Utility:CreateModule({
		Name = 'AutoCamel',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoCloudGrind = fable.Categories.Utility:CreateModule({
		Name = 'AutoCloudGrind',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	AutoFish = fable.Categories.Utility:CreateModule({
		Name = 'AutoFish',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoPaint = fable.Categories.Utility:CreateModule({
		Name = 'AutoPaint',
		Function = function(callback)
			if callback then
