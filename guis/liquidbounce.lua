...
local getcustomassets = {
	['FableV4/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['FableV4/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['FableV4/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['FableV4/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['FableV4/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['FableV4/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['FableV4/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['FableV4/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['FableV4/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['FableV4/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
	['FableV4/assets/new/blur.png'] = 'rbxassetid://14898786664'
}
...
local function writeFont()
	...
	--[[writefile('FableV4/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('FableV4/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('FableV4/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('FableV4/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
	return getcustomasset('FableV4/assets/liquidbounce/lbfont.json')
end
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		preview.Image = getcustomasset('FableV4/assets/new/colorpreview.png')
		...
		rainbow1.Image = getcustomasset('FableV4/assets/new/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('FableV4/assets/new/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('FableV4/assets/new/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('FableV4/assets/new/rainbow_4.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		dropdownexpand.Image = getcustomasset('FableV4/assets/liquidbounce/expand.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('FableV4/assets/new/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('FableV4/assets/new/targetplayers1.png'),
			IconSize = UDim2.fromOffset(15, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('FableV4/assets/new/targetplayers2.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('FableV4/assets/new/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('FableV4/assets/new/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('FableV4/assets/new/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('FableV4/assets/new/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('FableV4/assets/new/add.png')
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('FableV4/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('FableV4/assets/liquidbounce/combat.png'),
	Size = UDim2.fromOffset(16, 15)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('FableV4/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('FableV4/assets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('FableV4/assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('FableV4/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('FableV4/assets/liquidbounce/inventory.png'),
	Size = UDim2.fromOffset(14, 15)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('FableV4/assets/liquidbounce/minigames.png'),
	Size = UDim2.fromOffset(15, 15)
})
