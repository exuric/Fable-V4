...
local getcustomassets = {
	['FableV4/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['FableV4/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['FableV4/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['FableV4/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['FableV4/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['FableV4/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['FableV4/assets/old/info.png'] = 'rbxasset://info.png',
	['FableV4/assets/old/pin.png'] = 'rbxasset://pin.png',
	['FableV4/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['FableV4/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['FableV4/assets/old/search.png'] = 'rbxasset://search.png',
	['FableV4/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['FableV4/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['FableV4/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['FableV4/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['FableV4/assets/old/textfable.png'] = 'rbxasset://textfable.png',
	['FableV4/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['FableV4/assets/old/fable.png'] = 'rbxassetid://14373395239',
	['FableV4/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
...
do
	local res = isfile('FableV4/profiles/color.txt') and loadJson('FableV4/profiles/color.txt')
	if res then
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		expand.Image = getcustomasset('FableV4/assets/new/expandicon.png')
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('FableV4/assets/old/checkbox.png')
	...
	TwoSlider = function(optionsettings, children, api)
		...
		arrow.Image = getcustomasset('FableV4/assets/new/rangearrow.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('FableV4/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('FableV4/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('FableV4/assets/old/search.png')
	...
	function categoryapi:CreateBind()
		...
		function optionapi:SetBind(tab, mouse)
			...
			if mainapi.FableButton then
				mainapi.FableButton:Destroy()
				mainapi.FableButton = nil
			end
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('FableV4/assets/old/pin.png')
			...
			if categorysettings.Profiles then
				...
				if ind then
					if val ~= 'default' then
						...
						if isfile('FableV4/profiles/'..val..mainapi.Place..'.txt') and delfile then
							delfile('FableV4/profiles/'..val..mainapi.Place..'.txt')
						end
					end
				else
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('FableV4/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('FableV4/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('FableV4/profiles/'..self.Profile..self.Place..'.txt')
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('FableV4/assets/old/fable.png')
		image.Parent = button
		self.FableButton = button
		button.MouseButton1Click:Connect(function()
			if self.ThreadFix then
				setthreadidentity(8)
			end
...
function mainapi:Save(newprofile)
	...
	writefile('FableV4/profiles/'..self.Profile..self.Place..'.txt', httpService:JSONEncode(savedata))
end
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('FableV4/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('FableV4/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('FableV4/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('FableV4/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('FableV4/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('FableV4/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('FableV4/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('FableV4/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('FableV4/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('FableV4/assets/old/profilesicon.png'),
...
topbar:CreateButton({
	...
	mainapi.Save = function() end
		if isfile('FableV4/profiles/'..mainapi.Profile..mainapi.Place..'.txt') and delfile then
			delfile('FableV4/profiles/'..mainapi.Profile..mainapi.Place..'.txt')
		end
		shared.fablereload = true
		if shared.FableDeveloper then
			loadstring(readfile('FableV4/loader.lua'), 'loader')()
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('FableV4/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
local FableTextScale = Instance.new('UIScale')
FableTextScale.Parent = textgui.Children
...
local FableLabels = {}
local FableLogo = Instance.new('ImageLabel')
FableLogo.Name = 'Logo'
FableLogo.Size = UDim2.fromOffset(96, 26)
FableLogo.Position = UDim2.new(1, -142, 0, 3)
FableLogo.BackgroundTransparency = 1
FableLogo.BorderSizePixel = 0
FableLogo.Visible = true
FableLogo.BackgroundColor3 = Color3.new()
FableLogo.Image = getcustomasset('FableV4/assets/old/textfable.png')
FableLogo.Parent = textgui.Children
...
local FableLogoV4 = Instance.new('ImageLabel')
FableLogoV4.Name = 'Logo2'
FableLogoV4.Size = UDim2.fromOffset(43, 30)
FableLogoV4.Position = UDim2.new(1, 1, 0, -2)
FableLogoV4.BackgroundColor3 = Color3.new()
FableLogoV4.BackgroundTransparency = 1
FableLogoV4.BorderSizePixel = 0
FableLogoV4.Image = getcustomasset('FableV4/assets/old/textv4.png')
FableLogoV4.Parent = FableLogo
local FableLogoShadow = FableLogo:Clone()
FableLogoShadow.Position = UDim2.fromOffset(1, 1)
FableLogoShadow.ZIndex = 0
FableLogoShadow.Visible = true
FableLogoShadow.ImageColor3 = Color3.new()
FableLogoShadow.ImageTransparency = 0.65
FableLogoShadow.Parent = FableLogo
FableLogoShadow.Logo2.ZIndex = 0
FableLogoShadow.Logo2.ImageColor3 = Color3.new()
FableLogoShadow.Logo2.ImageTransparency = 0.65
local FableLogoGradient = Instance.new('UIGradient')
FableLogoGradient.Rotation = 90
FableLogoGradient.Parent = FableLogo
local FableLogoGradient2 = Instance.new('UIGradient')
FableLogoGradient2.Rotation = 90
FableLogoGradient2.Parent = FableLogoV4
local FableLabelHolder = Instance.new('Frame')
FableLabelHolder.Name = 'Holder'
FableLabelHolder.Size = UDim2.fromScale(1, 1)
FableLabelHolder.Position = UDim2.fromOffset(5, 37)
FableLabelHolder.BackgroundTransparency = 1
FableLabelHolder.Parent = textgui.Children
local FableLabelSorter = Instance.new('UIListLayout')
FableLabelSorter.HorizontalAlignment = Enum.HorizontalAlignment.Right
FableLabelSorter.VerticalAlignment = Enum.VerticalAlignment.Top
FableLabelSorter.SortOrder = Enum.SortOrder.LayoutOrder
FableLabelSorter.Parent = FableLabelHolder
...
function mainapi:UpdateTextGUI(afterload)
	...
	if textgui.Button.Enabled then
		...
		FableLogo.Visible = textguiwatermark.Enabled
		FableLogo.Position = right and UDim2.new(1 / FableTextScale.Scale, -141, 0, 4) or UDim2.fromOffset(5, 4)
		FableLogoShadow.Visible = textguishadow.Enabled
		FableLabelSorter.HorizontalAlignment = right and Enum.HorizontalAlignment.Right or Enum.HorizontalAlignment.Left
		FableLabelHolder.Size = UDim2.fromScale(1 / FableTextScale.Scale, 1)
		FableLabelHolder.Position = UDim2.fromOffset(4, 4 + (FableLogo.Visible and FableLogo.Size.Y.Offset or 0))

		local found = {}
		for _, v in FableLabels do
			if v.Enabled then
				table.insert(found, v.Object.Name)
			end
			v.Object:Destroy()
		end
		table.clear(FableLabels)
		...
		for i, v in mainapi.Modules do
			...
			if v.Enabled or table.find(found, i) then
				...
				holder.Parent = FableLabelHolder
		...
		if textguisort.Value == 'Alphabetical' then
			table.sort(FableLabels, function(a, b)
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		FableLogoGradient.Color = ColorSequence.new({
		...
		FableLogoGradient2.Color = mainapi.GUIColor.Rainbow and FableLogoGradient.Color or ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))
		})
		for i, v in FableLabels do
			v.Text.TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((i + 2) * 0.025)) % 1)) or FableLogoGradient.Color.Keypoints[2].Value)
		end
	end
